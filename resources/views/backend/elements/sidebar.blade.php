    ...
    <div data-simplebar class="h-100">
        ...
        <div id="sidebar-menu">
            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    <a href="javascript: void(0);" class="waves-effect">
                        <i class="dripicons-blog"></i><span class="badge badge-pill badge-success float-right">9</span>
                        <span> Forms </span>
                    </a>
                    <ul class="sub-menu" aria-expanded="false">
                ...
                <li>
                    <a href="javascript: void(0);" class="waves-effect">
                        <i class="dripicons-map"></i><span class="badge badge-pill badge-danger float-right">2</span>
                        <span> Maps </span>
                    </a>
                    <ul class="sub-menu" aria-expanded="false">
