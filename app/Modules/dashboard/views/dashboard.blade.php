                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table mt-4 mb-0 table-centered table-nowrap">
                                ...
                                <tr>
                                    <td>
                                        <img src="assets/images/users/avatar-2.jpg" alt="user-image" class="avatar-sm rounded-circle mr-2" /> Herbert C. Patton
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        <img src="assets/images/users/avatar-3.jpg" alt="user-image" class="avatar-sm rounded-circle mr-2" /> Mathias N. Klausen
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        <img src="assets/images/users/avatar-4.jpg" alt="user-image" class="avatar-sm rounded-circle mr-2" /> Nikolaj S. Henriksen
                                    </td>
                                    <td><i class="mdi mdi-checkbox-blank-circle text-success"></i> Confirm</td>
                                    <td>
                                        $954
                                ...
                                <tr>
                                    <td>
                                        <img src="assets/images/users/avatar-5.jpg" alt="user-image" class="avatar-sm rounded-circle mr-2" /> Lasse C. Overgaard
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        <img src="assets/images/users/avatar-6.jpg" alt="user-image" class="avatar-sm rounded-circle mr-2" /> Kasper S. Jessen
                                    </td>
                                    <td><i class="mdi mdi-checkbox-blank-circle text-success"></i> Confirm</td>
                                    <td>
                                        $8,844
